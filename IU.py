...
class VistaCohete:
    ...
    def _create_center_panel(self):
        ...
        self.notebook.add(self.tab_datos, text="📊 Datos Principales")
        self.notebook.add(self.tab_visualizacion, text="🌍 Visualización 3D")
...
class ControladorCohete:
    def __init__(self, root):
        ...
        self.vista.controller = self  # Referencia circular para acceso desde la vista
    ...
    def _setup_bindings(self):
        ...
        self.vista.slider_kp.bind("<ButtonRelease-1>", lambda e: self.adjust_pid())
        self.vista.slider_ki.bind("<ButtonRelease-1>", lambda e: self.adjust_pid())
        self.vista.slider_kd.bind("<ButtonRelease-1>", lambda e: self.adjust_pid())
    
    def _start_data_update(self):
        """Inicia el proceso de actualización periódica de datos"""
        self.update_data()
    ...
    def update_data(self):
        ...
        try:
            ...
            self.vista.root.after(1000, self.update_data)  # Reintentar después de 1s
    ...
    def desplegar_tren(self):
        """Intenta desplegar el tren de aterrizaje"""
        return self.modelo.desplegar_tren()
    ...
    def reiniciar_simulacion(self):
        ...
        self.vista.consola.configure(state="normal")
        self.vista.consola.delete("1.0", "end")
        self.vista.consola.insert("end", ">>> Simulación reiniciada\n", "info")
        self.vista.consola.insert("end", ">>> Todos los sistemas verificados\n", "success")
        self.vista.consola.insert("end", ">>> Listo para secuencia de descenso\n", "info")
        self.vista.consola.configure(state="disabled")
